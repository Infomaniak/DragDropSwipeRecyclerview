package com.github.infomaniak.dragdropswiperecyclerviewsample.data.source
...
class IceCreamRepository : BaseRepository<IceCream>() {
    ...
    override fun generateNewItem(): IceCream {
        ...
        val iceCream =
            IceCream(iceCreamName, iceCreamPrice, enhancedRed, enhancedGreen, enhancedBlue)
    ...
    private fun enhanceColorIntensity(
        red: Float,
        green: Float,
        blue: Float
    ...
    private fun generateIceCreamName() =
